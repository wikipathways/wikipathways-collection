...
* GeneTests
    ...
    * outdatedIdentifiers2: .x we found 1 problem(s):
        * [Old HGNC identifiers detected: 2](#d628ce9d)
...
## GeneTests.outdatedIdentifiers2

Old HGNC identifiers detected: 2
```
http://classic.wikipathways.org/instance/WP5434_r139932 CALML2 has CALML2 but has been replace by CALM1
http://classic.wikipathways.org/instance/WP5434_r139932 CALML1 has CALML1 but has been replace by CALM1P1
```
