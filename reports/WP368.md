...
```
[["mb"],
["https://identifiers.org/chebi/CHEBI:83139"],
...
```
http://www.wikipathways.org/instance/WP368_r117795 (example) has: trans-D2-Enoyl-CoA CHEBI:10723 with InChIKeys: MGNBGCRQQFMNBM-YJHHLLFWSA-N, MGNBGCRQQFMNBM-VHTAIFHGSA-N
```
...
```
http://www.wikipathways.org/instance/WP368_r117795 'Mitochondrial long chain fatty acid beta-oxidation' in Homo sapiens has zero references; 
```
