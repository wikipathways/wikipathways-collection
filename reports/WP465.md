...
```
http://www.wikipathways.org/instance/WP465_r119262 'Tryptophan metabolism' in Homo sapiens has zero references; 
```
...
```
https://identifiers.org/chebi/CHEBI:27597 (5-Hydroxyindolepyruvate) does not have a Wikidata mapping in http://www.wikipathways.org/instance/WP465_r119262 ; 
```
